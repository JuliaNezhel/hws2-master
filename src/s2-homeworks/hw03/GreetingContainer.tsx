...
export const pureOnBlur = (name: string, setError: (eror: string) => void) => { // если имя пустое - показать ошибку
    if (name.trim() == '') {
...
const GreetingContainer: React.FC<GreetingContainerPropsType> = ({
    ...
    const lastUserName = users.length > 0 ? users[users.length - 1].name : false /// need to fix
